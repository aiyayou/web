...
<header class="am-g am-g-fixed blog-fixed blog-text-center blog-header">
    <div class="am-u-sm-8 am-u-sm-centered">
        <img width="200" src="assets/i/b1.jpg" alt="Amaze UI Logo"/>
        <h2 class="am-hide-sm-only">lzm的个人博客，用于分享心情、事件</h2>
    </div>
</header>
<hr>
<!-- nav start -->
    ...
    <ul class="am-nav am-nav-pills am-topbar-nav">
      ...
      <li class="am-dropdown" data-am-dropdown>
        ...
        <ul class="am-dropdown-content">
          <li><a href="index.jsp">1. blog-index-standard</a></li>
          <li><a href="index-nosidebar.jsp">2. blog-index-nosidebar</a></li>
          <li><a href="index-center.jsp">3. blog-index-layout</a></li>
          <li><a href="index-noslider.jsp">4. blog-index-noslider</a></li>
        </ul>
      </li>

      <li><a href="article.jsp">标准文章</a></li>
      <li><a href="img.jsp">图片库</a></li>
      <li><a href="article-fullwidth.jsp">全宽页面</a></li>
      <li><a href="timeline.jsp">存档</a></li>
    </ul>
